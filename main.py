...
label = Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 32, "bold"), )
label.grid(column=1, row=0)

button = Button(text="Start", highlightthickness=0, command=start_timer)
button.grid(column=0, row=2)

button_1 = Button(text="Reset", highlightthickness=0,command=reset_timer)
button_1.grid(column=2, row=2)

tick_button = Label(fg=GREEN, bg=YELLOW)
